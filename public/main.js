...
function draw() {
  ...
  var freq = map(rotationX, 0.00, 0.99, 0, 120);
  osc.freq(freq);

  //var amp = map(round(yaw), -180, 180, 0, 255);
  var amp = map(rotationY, 0.00, 0.99, 0, 120);
  osc.amp(amp);

  //filterFreq = map(round(roll), -180, 180, 0, 255);
  filterFreq = map(rotationX, 0.00, 0.99, 0, 120);
  //filterWidth = map(round(yaw), -180, 180, 0, 255);
  filterWidth = map(rotationY, 0.00, 0.99, 0, 120);
